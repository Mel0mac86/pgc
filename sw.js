...
self.addEventListener('fetch', e => {
  ...
  if (!e.request.url.startsWith(self.location.origin)) return; // scanner/Groq/Open Food Facts passano
  // network-first: se online usa la versione aggiornata, altrimenti la cache
  e.respondWith(
